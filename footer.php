    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 mr-auto text-center">
          ...
          <p>
            <a href="mailto:your-email@your-domain.com"><?=gila::option('theme.contact-email','feedback@startbootstrap.com')?></a>
          </p>
        </div>
      </div>
    </div>
  ...
  <script src="themes/startbootstrap-creative/vendor/jquery/jquery.min.js"></script>
  <script src="themes/startbootstrap-creative/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

  <!-- Plugin JavaScript -->
  <script src="themes/startbootstrap-creative/vendor/jquery-easing/jquery.easing.min.js"></script>
  <script src="themes/startbootstrap-creative/vendor/scrollreveal/scrollreveal.min.js"></script>
