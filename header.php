...
view::stylesheet("themes/startbootstrap-creative/css/creative.min.css");
view::head();
?>
<style>
header.masthead {
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="<?=gila::base_url()?>#page-top"><?=gila::config('title')?></a>
